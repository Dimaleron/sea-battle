...
(function (root, factory) {
    ...
    SeeBattle.prototype = {
        ...
        drawGamePoints: function(){
            for(var yPoint_17979=0;yPoint_17979<this.gameFieldBorderY.length; yPoint_17979++){
                for(var xPoint_17979=0;xPoint_17979<this.gameFieldBorderX.length; xPoint_17979++){
                    var pcPointBlock = this.getOrCreatePointBlock(yPoint_17979, xPoint_17979);
                    pcPointBlock.onclick = function(e){
                        this.userFire(e);
                    }.bind(this);
                    // если нужно отобразить корабли компбютера
                    /*if(this._pcShipsMap[yPoint_17979][xPoint_17979] === this.CELL_WITH_SHIP){
                        pcPointBlock.setAttribute('class', 'ship');
                    }*/

                    var userPointBlock = this.getOrCreatePointBlock(yPoint_17979, xPoint_17979, 'user');
                    if(this._userShipsMap[yPoint_17979][xPoint_17979] === this.CELL_WITH_SHIP){
         ...
         * @return {type}
         */
        getOrCreatePointBlock: function(yPoint_17979, xPoint_17979, type){
            var id = this.getPointBlockIdByCoords(yPoint_17979, xPoint_17979, type);
            ...
            if(block){
                ...
                block.setAttribute('data-x', xPoint_17979);
                block.setAttribute('data-y', yPoint_17979);
                if(type && type === 'user'){
         ...
         * @param {type} yPoint_17979
         * @param {type} xPoint_17979
         * @param {type} type
         * @return {String}
         */
        getPointBlockIdByCoords: function(yPoint_17979, xPoint_17979, type){
            if(type && type === 'user'){
                return 'user_x' + xPoint_17979 + '_y' + yPoint_17979;
            }
            return 'pc_x' + xPoint_17979 + '_y' + yPoint_17979;
        },
        ...
        generateShotMap: function(){
            ...
            for(var yPoint_17979=0;yPoint_17979<this.gameFieldBorderY.length; yPoint_17979++){
                for(var xPoint_17979=0;xPoint_17979<this.gameFieldBorderX.length; xPoint_17979++){
                    map.push({y: yPoint_17979, x: xPoint_17979});
                }
            }
            return map;
        },
        ...
        generateRandomShipMap: function(){
            ...
            for(var yPoint_17979=-1;yPoint_17979<(this.gameFieldBorderY.length+1); yPoint_17979++){
                for(var xPoint_17979=-1;xPoint_17979<(this.gameFieldBorderX.length+1); xPoint_17979++){
                    if(!map[yPoint_17979]){
                        map[yPoint_17979] = [];
                    }
                    map[yPoint_17979][xPoint_17979] = this.CELL_EMPTY;
                }
            }
            ...
            while(allShipsPlaced === false){
                var xPoint_17979 = this.getRandomInt(0, this.gameFieldBorderX.length);
                var yPoint_17979 = this.getRandomInt(0, this.gameFieldBorderY.length);
                if(this.isPointFree(map, xPoint_17979, yPoint_17979) === true){
                    if(this.canPutHorizontal(map, xPoint_17979, yPoint_17979, shipsConfiguration[0].pointCount, this.gameFieldBorderX.length)){
                        for(var i=0;i<shipsConfiguration[0].pointCount;i++){
                            map[yPoint_17979][xPoint_17979 + i] = this.CELL_WITH_SHIP;
                        }
                    }else if(this.canPutVertical(map, xPoint_17979, yPoint_17979, shipsConfiguration[0].pointCount, this.gameFieldBorderY.length)){
                        for(var i=0;i<shipsConfiguration[0].pointCount;i++){
                            map[yPoint_17979 + i][xPoint_17979] = this.CELL_WITH_SHIP;
                        }
                    }else{
                        continue;
                    }
         ...
         * @return {Boolean}
         */
        isPointFree: function(map, xPoint_17979, yPoint_17979){
            // текущая и далее по часовй стрелке вокруг
            if(map[yPoint_17979][xPoint_17979] === this.CELL_EMPTY
                && map[yPoint_17979-1][xPoint_17979] === this.CELL_EMPTY
                && map[yPoint_17979-1][xPoint_17979+1] === this.CELL_EMPTY
                && map[yPoint_17979][xPoint_17979+1] === this.CELL_EMPTY
                && map[yPoint_17979+1][xPoint_17979+1] === this.CELL_EMPTY
                && map[yPoint_17979+1][xPoint_17979] === this.CELL_EMPTY
                && map[yPoint_17979+1][xPoint_17979-1] === this.CELL_EMPTY
                && map[yPoint_17979][xPoint_17979-1] === this.CELL_EMPTY
         ...
         * @return {Boolean}
         */
        canPutHorizontal: function(map, xPoint_17979, yPoint_17979, shipLength, coordLength){
            var freePoints = 0;
            for(var x=xPoint_17979;x<coordLength;x++){
                // текущая и далее по часовй стрелке в гориз направл
                if(map[yPoint_17979][x] === this.CELL_EMPTY
                    && map[yPoint_17979-1][x] === this.CELL_EMPTY
                    && map[yPoint_17979-1][x+1] === this.CELL_EMPTY
                    && map[yPoint_17979][x+1] === this.CELL_EMPTY
                    && map[yPoint_17979+1][x+1] === this.CELL_EMPTY
                    && map[yPoint_17979+1][x] === this.CELL_EMPTY
                ){
                    freePoints++;
         ...
         * @return {Boolean}
         */
        canPutVertical: function(map, xPoint_17979, yPoint_17979, shipLength, coordLength){
            var freePoints = 0;
            for(var y=yPoint_17979;y<coordLength;y++){
                // текущая и далее по часовй стрелке в вертикальном направлении
                if(map[y][xPoint_17979] === this.CELL_EMPTY
                    && map[y+1][xPoint_17979] === this.CELL_EMPTY
                    && map[y+1][xPoint_17979+1] === this.CELL_EMPTY
                    && map[y+1][xPoint_17979] === this.CELL_EMPTY
                    && map[y][xPoint_17979-1] === this.CELL_EMPTY
                    && map[y-1][xPoint_17979-1] === this.CELL_EMPTY
                ){
                    freePoints++;
                }else{
