...
(function (root, factory) {
    ...
    SeeBattle.prototype = {
        ...
        drawGamePoints: function(){
            for(var yPoint_28571=0;yPoint_28571<this.gameFieldBorderY.length; yPoint_28571++){
                for(var xPoint_28571=0;xPoint_28571<this.gameFieldBorderX.length; xPoint_28571++){
                    var pcPointBlock = this.getOrCreatePointBlock(yPoint_28571, xPoint_28571);
                    pcPointBlock.onclick = function(e){
                        this.userFire(e);
                    }.bind(this);
                    // если нужно отобразить корабли компбютера
                    /*if(this._pcShipsMap[yPoint_28571][xPoint_28571] === this.CELL_WITH_SHIP){
                        pcPointBlock.setAttribute('class', 'ship');
                    }*/

                    var userPointBlock = this.getOrCreatePointBlock(yPoint_28571, xPoint_28571, 'user');
                    if(this._userShipsMap[yPoint_28571][xPoint_28571] === this.CELL_WITH_SHIP){
         ...
         * @return {type}
         */
        getOrCreatePointBlock: function(yPoint_28571, xPoint_28571, type){
            var id = this.getPointBlockIdByCoords(yPoint_28571, xPoint_28571, type);
            ...
            if(block){
                ...
                block.setAttribute('data-x', xPoint_28571);
                block.setAttribute('data-y', yPoint_28571);
                if(type && type === 'user'){
         ...
         * @param {type} yPoint_28571
         * @param {type} xPoint_28571
         * @param {type} type
         * @return {String}
         */
        getPointBlockIdByCoords: function(yPoint_28571, xPoint_28571, type){
            if(type && type === 'user'){
                return 'user_x' + xPoint_28571 + '_y' + yPoint_28571;
            }
            return 'pc_x' + xPoint_28571 + '_y' + yPoint_28571;
        },
        ...
        generateShotMap: function(){
            ...
            for(var yPoint_28571=0;yPoint_28571<this.gameFieldBorderY.length; yPoint_28571++){
                for(var xPoint_28571=0;xPoint_28571<this.gameFieldBorderX.length; xPoint_28571++){
                    map.push({y: yPoint_28571, x: xPoint_28571});
                }
            }
            return map;
        },
        ...
        generateRandomShipMap: function(){
            ...
            for(var yPoint_28571=-1;yPoint_28571<(this.gameFieldBorderY.length+1); yPoint_28571++){
                for(var xPoint_28571=-1;xPoint_28571<(this.gameFieldBorderX.length+1); xPoint_28571++){
                    if(!map[yPoint_28571]){
                        map[yPoint_28571] = [];
                    }
                    map[yPoint_28571][xPoint_28571] = this.CELL_EMPTY;
                }
            }
            ...
            while(allShipsPlaced === false){
                var xPoint_28571 = this.getRandomInt(0, this.gameFieldBorderX.length);
                var yPoint_28571 = this.getRandomInt(0, this.gameFieldBorderY.length);
                if(this.isPointFree(map, xPoint_28571, yPoint_28571) === true){
                    if(this.canPutHorizontal(map, xPoint_28571, yPoint_28571, shipsConfiguration[0].pointCount, this.gameFieldBorderX.length)){
                        for(var i=0;i<shipsConfiguration[0].pointCount;i++){
                            map[yPoint_28571][xPoint_28571 + i] = this.CELL_WITH_SHIP;
                        }
                    }else if(this.canPutVertical(map, xPoint_28571, yPoint_28571, shipsConfiguration[0].pointCount, this.gameFieldBorderY.length)){
                        for(var i=0;i<shipsConfiguration[0].pointCount;i++){
                            map[yPoint_28571 + i][xPoint_28571] = this.CELL_WITH_SHIP;
                        }
                    }else{
                        continue;
                    }
         ...
         * @return {Boolean}
         */
        isPointFree: function(map, xPoint_28571, yPoint_28571){
            // текущая и далее по часовй стрелке вокруг
            if(map[yPoint_28571][xPoint_28571] === this.CELL_EMPTY
                && map[yPoint_28571-1][xPoint_28571] === this.CELL_EMPTY
                && map[yPoint_28571-1][xPoint_28571+1] === this.CELL_EMPTY
                && map[yPoint_28571][xPoint_28571+1] === this.CELL_EMPTY
                && map[yPoint_28571+1][xPoint_28571+1] === this.CELL_EMPTY
                && map[yPoint_28571+1][xPoint_28571] === this.CELL_EMPTY
                && map[yPoint_28571+1][xPoint_28571-1] === this.CELL_EMPTY
                && map[yPoint_28571][xPoint_28571-1] === this.CELL_EMPTY
         ...
         * @return {Boolean}
         */
        canPutHorizontal: function(map, xPoint_28571, yPoint_28571, shipLength, coordLength){
            var freePoints = 0;
            for(var x=xPoint_28571;x<coordLength;x++){
                // текущая и далее по часовй стрелке в гориз направл
                if(map[yPoint_28571][x] === this.CELL_EMPTY
                    && map[yPoint_28571-1][x] === this.CELL_EMPTY
                    && map[yPoint_28571-1][x+1] === this.CELL_EMPTY
                    && map[yPoint_28571][x+1] === this.CELL_EMPTY
                    && map[yPoint_28571+1][x+1] === this.CELL_EMPTY
                    && map[yPoint_28571+1][x] === this.CELL_EMPTY
                ){
                    freePoints++;
         ...
         * @return {Boolean}
         */
        canPutVertical: function(map, xPoint_28571, yPoint_28571, shipLength, coordLength){
            var freePoints = 0;
            for(var y=yPoint_28571;y<coordLength;y++){
                // текущая и далее по часовй стрелке в вертикальном направлении
                if(map[y][xPoint_28571] === this.CELL_EMPTY
                    && map[y+1][xPoint_28571] === this.CELL_EMPTY
                    && map[y+1][xPoint_28571+1] === this.CELL_EMPTY
                    && map[y+1][xPoint_28571] === this.CELL_EMPTY
                    && map[y][xPoint_28571-1] === this.CELL_EMPTY
                    && map[y-1][xPoint_28571-1] === this.CELL_EMPTY
                ){
                    freePoints++;
                }else{
