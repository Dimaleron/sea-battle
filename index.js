...
(function (root, factory) {
    ...
    SeeBattle.prototype = {
        ...
        drawGamePoints: function(){
            for(var yPoint_17140=0;yPoint_17140<this.gameFieldBorderY.length; yPoint_17140++){
                for(var xPoint_17140=0;xPoint_17140<this.gameFieldBorderX.length; xPoint_17140++){
                    var pcPointBlock = this.getOrCreatePointBlock(yPoint_17140, xPoint_17140);
                    pcPointBlock.onclick = function(e){
                        this.userFire(e);
                    }.bind(this);
                    // если нужно отобразить корабли компбютера
                    /*if(this._pcShipsMap[yPoint_17140][xPoint_17140] === this.CELL_WITH_SHIP){
                        pcPointBlock.setAttribute('class', 'ship');
                    }*/

                    var userPointBlock = this.getOrCreatePointBlock(yPoint_17140, xPoint_17140, 'user');
                    if(this._userShipsMap[yPoint_17140][xPoint_17140] === this.CELL_WITH_SHIP){
         ...
         * @return {type}
         */
        getOrCreatePointBlock: function(yPoint_17140, xPoint_17140, type){
            var id = this.getPointBlockIdByCoords(yPoint_17140, xPoint_17140, type);
            ...
            if(block){
                ...
                block.setAttribute('data-x', xPoint_17140);
                block.setAttribute('data-y', yPoint_17140);
                if(type && type === 'user'){
         ...
         * @param {type} yPoint_17140
         * @param {type} xPoint_17140
         * @param {type} type
         * @return {String}
         */
        getPointBlockIdByCoords: function(yPoint_17140, xPoint_17140, type){
            if(type && type === 'user'){
                return 'user_x' + xPoint_17140 + '_y' + yPoint_17140;
            }
            return 'pc_x' + xPoint_17140 + '_y' + yPoint_17140;
        },
        ...
        generateShotMap: function(){
            ...
            for(var yPoint_17140=0;yPoint_17140<this.gameFieldBorderY.length; yPoint_17140++){
                for(var xPoint_17140=0;xPoint_17140<this.gameFieldBorderX.length; xPoint_17140++){
                    map.push({y: yPoint_17140, x: xPoint_17140});
                }
            }
            return map;
        },
        ...
        generateRandomShipMap: function(){
            ...
            for(var yPoint_17140=-1;yPoint_17140<(this.gameFieldBorderY.length+1); yPoint_17140++){
                for(var xPoint_17140=-1;xPoint_17140<(this.gameFieldBorderX.length+1); xPoint_17140++){
                    if(!map[yPoint_17140]){
                        map[yPoint_17140] = [];
                    }
                    map[yPoint_17140][xPoint_17140] = this.CELL_EMPTY;
                }
            }
            ...
            while(allShipsPlaced === false){
                var xPoint_17140 = this.getRandomInt(0, this.gameFieldBorderX.length);
                var yPoint_17140 = this.getRandomInt(0, this.gameFieldBorderY.length);
                if(this.isPointFree(map, xPoint_17140, yPoint_17140) === true){
                    if(this.canPutHorizontal(map, xPoint_17140, yPoint_17140, shipsConfiguration[0].pointCount, this.gameFieldBorderX.length)){
                        for(var i=0;i<shipsConfiguration[0].pointCount;i++){
                            map[yPoint_17140][xPoint_17140 + i] = this.CELL_WITH_SHIP;
                        }
                    }else if(this.canPutVertical(map, xPoint_17140, yPoint_17140, shipsConfiguration[0].pointCount, this.gameFieldBorderY.length)){
                        for(var i=0;i<shipsConfiguration[0].pointCount;i++){
                            map[yPoint_17140 + i][xPoint_17140] = this.CELL_WITH_SHIP;
                        }
                    }else{
                        continue;
                    }
         ...
         * @return {Boolean}
         */
        isPointFree: function(map, xPoint_17140, yPoint_17140){
            // текущая и далее по часовй стрелке вокруг
            if(map[yPoint_17140][xPoint_17140] === this.CELL_EMPTY
                && map[yPoint_17140-1][xPoint_17140] === this.CELL_EMPTY
                && map[yPoint_17140-1][xPoint_17140+1] === this.CELL_EMPTY
                && map[yPoint_17140][xPoint_17140+1] === this.CELL_EMPTY
                && map[yPoint_17140+1][xPoint_17140+1] === this.CELL_EMPTY
                && map[yPoint_17140+1][xPoint_17140] === this.CELL_EMPTY
                && map[yPoint_17140+1][xPoint_17140-1] === this.CELL_EMPTY
                && map[yPoint_17140][xPoint_17140-1] === this.CELL_EMPTY
         ...
         * @return {Boolean}
         */
        canPutHorizontal: function(map, xPoint_17140, yPoint_17140, shipLength, coordLength){
            var freePoints = 0;
            for(var x=xPoint_17140;x<coordLength;x++){
                // текущая и далее по часовй стрелке в гориз направл
                if(map[yPoint_17140][x] === this.CELL_EMPTY
                    && map[yPoint_17140-1][x] === this.CELL_EMPTY
                    && map[yPoint_17140-1][x+1] === this.CELL_EMPTY
                    && map[yPoint_17140][x+1] === this.CELL_EMPTY
                    && map[yPoint_17140+1][x+1] === this.CELL_EMPTY
                    && map[yPoint_17140+1][x] === this.CELL_EMPTY
                ){
                    freePoints++;
         ...
         * @return {Boolean}
         */
        canPutVertical: function(map, xPoint_17140, yPoint_17140, shipLength, coordLength){
            var freePoints = 0;
            for(var y=yPoint_17140;y<coordLength;y++){
                // текущая и далее по часовй стрелке в вертикальном направлении
                if(map[y][xPoint_17140] === this.CELL_EMPTY
                    && map[y+1][xPoint_17140] === this.CELL_EMPTY
                    && map[y+1][xPoint_17140+1] === this.CELL_EMPTY
                    && map[y+1][xPoint_17140] === this.CELL_EMPTY
                    && map[y][xPoint_17140-1] === this.CELL_EMPTY
                    && map[y-1][xPoint_17140-1] === this.CELL_EMPTY
                ){
                    freePoints++;
                }else{
