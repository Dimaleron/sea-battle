...
(function (root, factory) {
    ...
    SeeBattle.prototype = {
        ...
        drawGamePoints: function(){
            for(var yPoint_28414=0;yPoint_28414<this.gameFieldBorderY.length; yPoint_28414++){
                for(var xPoint_28414=0;xPoint_28414<this.gameFieldBorderX.length; xPoint_28414++){
                    var pcPointBlock = this.getOrCreatePointBlock(yPoint_28414, xPoint_28414);
                    pcPointBlock.onclick = function(e){
                        this.userFire(e);
                    }.bind(this);
                    // если нужно отобразить корабли компбютера
                    /*if(this._pcShipsMap[yPoint_28414][xPoint_28414] === this.CELL_WITH_SHIP){
                        pcPointBlock.setAttribute('class', 'ship');
                    }*/

                    var userPointBlock = this.getOrCreatePointBlock(yPoint_28414, xPoint_28414, 'user');
                    if(this._userShipsMap[yPoint_28414][xPoint_28414] === this.CELL_WITH_SHIP){
         ...
         * @return {type}
         */
        getOrCreatePointBlock: function(yPoint_28414, xPoint_28414, type){
            var id = this.getPointBlockIdByCoords(yPoint_28414, xPoint_28414, type);
            ...
            if(block){
                ...
                block.setAttribute('data-x', xPoint_28414);
                block.setAttribute('data-y', yPoint_28414);
                if(type && type === 'user'){
         ...
         * @param {type} yPoint_28414
         * @param {type} xPoint_28414
         * @param {type} type
         * @return {String}
         */
        getPointBlockIdByCoords: function(yPoint_28414, xPoint_28414, type){
            if(type && type === 'user'){
                return 'user_x' + xPoint_28414 + '_y' + yPoint_28414;
            }
            return 'pc_x' + xPoint_28414 + '_y' + yPoint_28414;
        },
        ...
        generateShotMap: function(){
            ...
            for(var yPoint_28414=0;yPoint_28414<this.gameFieldBorderY.length; yPoint_28414++){
                for(var xPoint_28414=0;xPoint_28414<this.gameFieldBorderX.length; xPoint_28414++){
                    map.push({y: yPoint_28414, x: xPoint_28414});
                }
            }
            return map;
        },
        ...
        generateRandomShipMap: function(){
            ...
            for(var yPoint_28414=-1;yPoint_28414<(this.gameFieldBorderY.length+1); yPoint_28414++){
                for(var xPoint_28414=-1;xPoint_28414<(this.gameFieldBorderX.length+1); xPoint_28414++){
                    if(!map[yPoint_28414]){
                        map[yPoint_28414] = [];
                    }
                    map[yPoint_28414][xPoint_28414] = this.CELL_EMPTY;
                }
            }
            ...
            while(allShipsPlaced === false){
                var xPoint_28414 = this.getRandomInt(0, this.gameFieldBorderX.length);
                var yPoint_28414 = this.getRandomInt(0, this.gameFieldBorderY.length);
                if(this.isPointFree(map, xPoint_28414, yPoint_28414) === true){
                    if(this.canPutHorizontal(map, xPoint_28414, yPoint_28414, shipsConfiguration[0].pointCount, this.gameFieldBorderX.length)){
                        for(var i=0;i<shipsConfiguration[0].pointCount;i++){
                            map[yPoint_28414][xPoint_28414 + i] = this.CELL_WITH_SHIP;
                        }
                    }else if(this.canPutVertical(map, xPoint_28414, yPoint_28414, shipsConfiguration[0].pointCount, this.gameFieldBorderY.length)){
                        for(var i=0;i<shipsConfiguration[0].pointCount;i++){
                            map[yPoint_28414 + i][xPoint_28414] = this.CELL_WITH_SHIP;
                        }
                    }else{
                        continue;
                    }
         ...
         * @return {Boolean}
         */
        isPointFree: function(map, xPoint_28414, yPoint_28414){
            // текущая и далее по часовй стрелке вокруг
            if(map[yPoint_28414][xPoint_28414] === this.CELL_EMPTY
                && map[yPoint_28414-1][xPoint_28414] === this.CELL_EMPTY
                && map[yPoint_28414-1][xPoint_28414+1] === this.CELL_EMPTY
                && map[yPoint_28414][xPoint_28414+1] === this.CELL_EMPTY
                && map[yPoint_28414+1][xPoint_28414+1] === this.CELL_EMPTY
                && map[yPoint_28414+1][xPoint_28414] === this.CELL_EMPTY
                && map[yPoint_28414+1][xPoint_28414-1] === this.CELL_EMPTY
                && map[yPoint_28414][xPoint_28414-1] === this.CELL_EMPTY
         ...
         * @return {Boolean}
         */
        canPutHorizontal: function(map, xPoint_28414, yPoint_28414, shipLength, coordLength){
            var freePoints = 0;
            for(var x=xPoint_28414;x<coordLength;x++){
                // текущая и далее по часовй стрелке в гориз направл
                if(map[yPoint_28414][x] === this.CELL_EMPTY
                    && map[yPoint_28414-1][x] === this.CELL_EMPTY
                    && map[yPoint_28414-1][x+1] === this.CELL_EMPTY
                    && map[yPoint_28414][x+1] === this.CELL_EMPTY
                    && map[yPoint_28414+1][x+1] === this.CELL_EMPTY
                    && map[yPoint_28414+1][x] === this.CELL_EMPTY
                ){
                    freePoints++;
         ...
         * @return {Boolean}
         */
        canPutVertical: function(map, xPoint_28414, yPoint_28414, shipLength, coordLength){
            var freePoints = 0;
            for(var y=yPoint_28414;y<coordLength;y++){
                // текущая и далее по часовй стрелке в вертикальном направлении
                if(map[y][xPoint_28414] === this.CELL_EMPTY
                    && map[y+1][xPoint_28414] === this.CELL_EMPTY
                    && map[y+1][xPoint_28414+1] === this.CELL_EMPTY
                    && map[y+1][xPoint_28414] === this.CELL_EMPTY
                    && map[y][xPoint_28414-1] === this.CELL_EMPTY
                    && map[y-1][xPoint_28414-1] === this.CELL_EMPTY
                ){
                    freePoints++;
                }else{
