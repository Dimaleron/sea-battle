...
(function (root, factory) {
    ...
    SeeBattle.prototype = {
        ...
        drawGamePoints: function(){
            for(var yPoint_18599=0;yPoint_18599<this.gameFieldBorderY.length; yPoint_18599++){
                for(var xPoint_18599=0;xPoint_18599<this.gameFieldBorderX.length; xPoint_18599++){
                    var pcPointBlock = this.getOrCreatePointBlock(yPoint_18599, xPoint_18599);
                    pcPointBlock.onclick = function(e){
                        this.userFire(e);
                    }.bind(this);
                    // если нужно отобразить корабли компбютера
                    /*if(this._pcShipsMap[yPoint_18599][xPoint_18599] === this.CELL_WITH_SHIP){
                        pcPointBlock.setAttribute('class', 'ship');
                    }*/

                    var userPointBlock = this.getOrCreatePointBlock(yPoint_18599, xPoint_18599, 'user');
                    if(this._userShipsMap[yPoint_18599][xPoint_18599] === this.CELL_WITH_SHIP){
         ...
         * @return {type}
         */
        getOrCreatePointBlock: function(yPoint_18599, xPoint_18599, type){
            var id = this.getPointBlockIdByCoords(yPoint_18599, xPoint_18599, type);
            ...
            if(block){
                ...
                block.setAttribute('data-x', xPoint_18599);
                block.setAttribute('data-y', yPoint_18599);
                if(type && type === 'user'){
         ...
         * @param {type} yPoint_18599
         * @param {type} xPoint_18599
         * @param {type} type
         * @return {String}
         */
        getPointBlockIdByCoords: function(yPoint_18599, xPoint_18599, type){
            if(type && type === 'user'){
                return 'user_x' + xPoint_18599 + '_y' + yPoint_18599;
            }
            return 'pc_x' + xPoint_18599 + '_y' + yPoint_18599;
        },
        ...
        generateShotMap: function(){
            ...
            for(var yPoint_18599=0;yPoint_18599<this.gameFieldBorderY.length; yPoint_18599++){
                for(var xPoint_18599=0;xPoint_18599<this.gameFieldBorderX.length; xPoint_18599++){
                    map.push({y: yPoint_18599, x: xPoint_18599});
                }
            }
            return map;
        },
        ...
        generateRandomShipMap: function(){
            ...
            for(var yPoint_18599=-1;yPoint_18599<(this.gameFieldBorderY.length+1); yPoint_18599++){
                for(var xPoint_18599=-1;xPoint_18599<(this.gameFieldBorderX.length+1); xPoint_18599++){
                    if(!map[yPoint_18599]){
                        map[yPoint_18599] = [];
                    }
                    map[yPoint_18599][xPoint_18599] = this.CELL_EMPTY;
                }
            }
            ...
            while(allShipsPlaced === false){
                var xPoint_18599 = this.getRandomInt(0, this.gameFieldBorderX.length);
                var yPoint_18599 = this.getRandomInt(0, this.gameFieldBorderY.length);
                if(this.isPointFree(map, xPoint_18599, yPoint_18599) === true){
                    if(this.canPutHorizontal(map, xPoint_18599, yPoint_18599, shipsConfiguration[0].pointCount, this.gameFieldBorderX.length)){
                        for(var i=0;i<shipsConfiguration[0].pointCount;i++){
                            map[yPoint_18599][xPoint_18599 + i] = this.CELL_WITH_SHIP;
                        }
                    }else if(this.canPutVertical(map, xPoint_18599, yPoint_18599, shipsConfiguration[0].pointCount, this.gameFieldBorderY.length)){
                        for(var i=0;i<shipsConfiguration[0].pointCount;i++){
                            map[yPoint_18599 + i][xPoint_18599] = this.CELL_WITH_SHIP;
                        }
                    }else{
                        continue;
                    }
         ...
         * @return {Boolean}
         */
        isPointFree: function(map, xPoint_18599, yPoint_18599){
            // текущая и далее по часовй стрелке вокруг
            if(map[yPoint_18599][xPoint_18599] === this.CELL_EMPTY
                && map[yPoint_18599-1][xPoint_18599] === this.CELL_EMPTY
                && map[yPoint_18599-1][xPoint_18599+1] === this.CELL_EMPTY
                && map[yPoint_18599][xPoint_18599+1] === this.CELL_EMPTY
                && map[yPoint_18599+1][xPoint_18599+1] === this.CELL_EMPTY
                && map[yPoint_18599+1][xPoint_18599] === this.CELL_EMPTY
                && map[yPoint_18599+1][xPoint_18599-1] === this.CELL_EMPTY
                && map[yPoint_18599][xPoint_18599-1] === this.CELL_EMPTY
         ...
         * @return {Boolean}
         */
        canPutHorizontal: function(map, xPoint_18599, yPoint_18599, shipLength, coordLength){
            var freePoints = 0;
            for(var x=xPoint_18599;x<coordLength;x++){
                // текущая и далее по часовй стрелке в гориз направл
                if(map[yPoint_18599][x] === this.CELL_EMPTY
                    && map[yPoint_18599-1][x] === this.CELL_EMPTY
                    && map[yPoint_18599-1][x+1] === this.CELL_EMPTY
                    && map[yPoint_18599][x+1] === this.CELL_EMPTY
                    && map[yPoint_18599+1][x+1] === this.CELL_EMPTY
                    && map[yPoint_18599+1][x] === this.CELL_EMPTY
                ){
                    freePoints++;
         ...
         * @return {Boolean}
         */
        canPutVertical: function(map, xPoint_18599, yPoint_18599, shipLength, coordLength){
            var freePoints = 0;
            for(var y=yPoint_18599;y<coordLength;y++){
                // текущая и далее по часовй стрелке в вертикальном направлении
                if(map[y][xPoint_18599] === this.CELL_EMPTY
                    && map[y+1][xPoint_18599] === this.CELL_EMPTY
                    && map[y+1][xPoint_18599+1] === this.CELL_EMPTY
                    && map[y+1][xPoint_18599] === this.CELL_EMPTY
                    && map[y][xPoint_18599-1] === this.CELL_EMPTY
                    && map[y-1][xPoint_18599-1] === this.CELL_EMPTY
                ){
                    freePoints++;
                }else{
